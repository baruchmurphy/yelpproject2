...
This project also includes skeleton loaders in the loading using react loading skeleton states as well as comprehensive error handling should the pages not be able to load.
